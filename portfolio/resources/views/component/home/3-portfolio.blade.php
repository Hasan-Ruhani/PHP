            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="gallery text-center full-width">
                        ...
                        <div class="items graphic">
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay valign">
                                    ...
                                    <a href="{{asset('img/portfolio/1.jpg')}}" class="popimg">
                        ...
                        <div class="items web">
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay valign">
                                    ...
                                    <a href="{{asset('img/portfolio/2.jpg')}}" class="popimg">
                                        <i class="icofont icofont-image"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="items web">
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay valign">
                                    ...
                                    <a href="{{asset('img/portfolio/6.jpg')}}" class="popimg">
                                        <i class="icofont icofont-image"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="items brand">
                            <div class="item-img">
                                <img src="{{asset('img/portfolio/7.jpg')}}" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info full-width vertical-center">
                                        <h6>Crearive Design</h6>
                                        <p>Work description here</p>
                                    </div>
                                    <a href="{{asset('img/portfolio/7.jpg')}}" class="popimg">
                                        <i class="icofont icofont-image"></i>
                                    </a>
                                </div>
                            </div>
